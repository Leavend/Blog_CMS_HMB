...
const AdjacentPostCard = ({ post, position }: { post: string, position: string }) => (
  <>
    <div className="absolute rounded-lg bg-center bg-no-repeat bg-cover shadow-md inline-block w-full h-72" style={{ backgroundImage: `url('${post.featuredImages.url}')` }} />
